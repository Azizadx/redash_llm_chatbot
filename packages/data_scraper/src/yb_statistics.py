...
class YTstats:
    ...
    def get_channel_video_data(self):
        ...
        # get viddeo statistics TODO: next video
    ...
    def _get_channel_videos(self, limit=None):
        ...
        video, npt = self._get_channel_videos_per_page(url)
        index = 0
    ...
    def _get_channel_videos_per_page(self, url):
        ...
        if 'items' not in data:
            return channel_videos, None  # an empty dictory
    ...
    def dump(self):
        ...
        fused_data = {self.channel_id: {
            "chnnel_statistics": self.channel_statistics,
